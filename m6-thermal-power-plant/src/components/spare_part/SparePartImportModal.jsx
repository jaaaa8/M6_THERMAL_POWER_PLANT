                        ...
                        <Modal.Body>
                            <div className="p-3 bg-light rounded mb-3" style={{ fontSize: 'var(--text-xs)' }}>
                                <Row className="mb-1">
                                    ...
                                    <Col xs={8} className="font-mono fw-semibold">{sparePartItem.sparePartCode}</Col>
                                </Row>
                                <Row>
                                    <Col xs={4} className="text-muted">Tên vật tư:</Col>
                                    <Col xs={8} className="fw-semibold">{sparePartItem.name}</Col>
                                </Row>
                            </div>
                            ...
                            <Row className="mb-3">
                                <Col md={6}>
                                    <label className="form-label">Số lượng nhập ({sparePartItem.unitName}) <span className="text-danger">*</span></label>
                                    <Field
                                        name="quantity"
                                        type="number"
                                        step="any"
